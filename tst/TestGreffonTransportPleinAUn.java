package tec;
class TestGreffonTransportPleinAUn {
    
    public void  testGreffonTransportPleinAUn(){

        GreffonTransportPlein_aUn greffon = new GreffonTransportPlein_aUn((Transport)new Autobus(1,2), new Collection_stock_memoire());
        ...
        assert greffon.greffonAUn_collect_data(0).get_NUM_ENTREE()==3;
        ...
        assert greffon.greffonAUn_collect_data(1).get_NUM_ENTREE()==0;
        assert greffon.greffonAUn_collect_data(1).get_NUM_SORTIE()==1;
        ...
        assert greffon.greffonAUn_collect_data(4).get_NUM_SORTIE()==1;
